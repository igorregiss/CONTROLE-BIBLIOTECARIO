...
<div id="layoutSidenav_content">
    <?php if (isset($_GET['no_s'])) { ?>
        <div class="toast ml-auto mr-1 bg-danger text-white" id="alerta" role="alert" data-delay="3000" aria-live="assertive" aria-atomic="true">
            ...
            Esse livro encontra-se indisponivel no momento!
            </div>
        </div>
    <?php } ?>
    <main>
                    ...
                    <table class="table" id="table">
                        ...
                        <tbody class="ttext">
                            <?php foreach ($data['prestamos'] as $row) {
                                if ($row['estado'] == 1) {
                                    $estado = '<span class="badge-danger p-1 rounded">Emprestado</span>';
                                } else {
                                    $estado = '<span class="badge-success p-1 rounded">Devolvido</span>';
                                }
                            ?>
                                <tr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="my-modal-title">Emprestar livro</h5>
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url(); ?>admin/registrar">
                            <div class="form-group">
                                <label for="buscar_libro">Livro</label><br>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="fecha_prestamo">Data de emprestimo</label>
                                        <input id="fecha_prestamo" class="form-control" type="date" name="fecha_prestamo" value="<?php echo date("Y-m-d"); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="fecha_devolucion">Data de devolução</label>
